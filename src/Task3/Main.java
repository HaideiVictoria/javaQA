...
public class Main {/*Реализовать данную ситуацию в коде.
...
Уважаемый Валентин стоимость ваших покупок 150. Вы приобрели APPLE в количестве 3, и MILK в количестве 6.*/
    ...
    public static void main(String[] args) {
        try {
            ...
            Shop shop = new Shop();
            Father father = new Father("Valentin", 250);
father.makeShop(ProductEmums.APPLE );
father.makeShop(ProductEmums.MILK);
            System.out.println("Уважаемый "+father.getFatherName()+" "+"стоимость ваших покупок "+shop.getPriceProduct()+" "+" Вы приобрели APPLE в количестве 3, и MILK в количестве 6.");}catch
